...
این API **موفقیت انتقال به ترازو را تضمین یا گزارش نمی‌کند**؛ موفقیت آن فقط یعنی درخواست Resend در DB ثبت شده است. برای نتیجه لحظه‌ای/قطعی انتقال، Service آینده لازم است.
