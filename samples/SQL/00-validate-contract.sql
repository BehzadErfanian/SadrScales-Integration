/*
  Sadr Scales SQL Contract v1 - read-only schema validation
  Baseline: Sadr Scales 5.2.1 after its own schema migration/check has run.
...
PRINT 'PASS - Sadr Scales SQL Contract v1 basic schema is available.';
